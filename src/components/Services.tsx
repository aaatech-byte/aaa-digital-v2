...
//             <div
//               key={index}
//               className="p-6 rounded-xl hover:border-primary hover:shadow-lg transition duration-300"
//             >
//               <service.icon className="h-12 w-12 text-yellow mb-4" />
//               <h3 className="text-xl font-semibold text-white mb-2">
//                 {service.title}
//               </h3>
//               <p className="text-white inline">{service.description}
...
//               >
//                 <span className="text-yellow font-bold">See more</span>
//                 <svg
