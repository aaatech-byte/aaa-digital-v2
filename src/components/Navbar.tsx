        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link
                ...
                className={`${location.pathname === link.to
                  ...
                  } hover:-translate-y-1 duration-200 ease-linear hover:text-yellow transition`}
              >
                {link.name}
              </Link>
            ))}
            <Link to="/contact">
              <button
                type="submit"
                className="flex justify-center gap-2 items-center mx-auto shadow-xl text-lg bg-yellow backdrop-blur-md lg:font-semibold isolation-auto text-black before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-gray-800 hover:text-yellow hover:border-emerald-600 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden rounded-full group"
              >
                Let's Talk
                <svg
                  className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-600 ease-linear duration-300 rounded-full border border-gray-900 group-hover:border-none p-2 rotate-45 bg-yellow"
                  viewBox="0 0 16 19"
